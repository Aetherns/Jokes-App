...
namespace Jokes_App.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View("Index", await _context.Joke.Where(j => j.JokesQuestion.Contains(SearchTerm)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokesQuestion,JokesAnswer")] Joke joke)
        {
